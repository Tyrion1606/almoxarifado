  ...
  "components": [
    {
      ...
      "status": "Estoque · quantidade estimada",
    ...
    },
    {
      ...
      "family": "STM32",
      "flash": "64 KiB (referência C8)",
      "gpio": "Até 37 no chip; depende da placa",
      "id": "bluepill",
      "kind": "placa",
      "logic": "3,3 V",
      "name": "BluePill",
      "notes": "Referência STM32F103C8T6: confirmar marcação das três unidades. Não assumir 128 KiB de Flash. USB e CAN compartilham recursos nesta família. Não confundir com o módulo ADS1256 + STM32F103.",
      "origin": "Usuário: três BluePill; associação ao TCC. Código C8 ainda não localizado no registro da placa.",
      "oscillator": "8 MHz externo típico; HSI interno 8 MHz",
      "package": "STM32F103C8T6 · LQFP-48 (referência)",
      "pinout": "stm32f103c8.png",
      ...
      "status": "Em estoque",
      "temperature": "−40 a +85 °C (chip de referência)",
